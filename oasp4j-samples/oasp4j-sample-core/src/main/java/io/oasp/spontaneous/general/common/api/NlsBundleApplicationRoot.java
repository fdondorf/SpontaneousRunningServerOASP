package io.oasp.spontaneous.general.common.api;
...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see io.oasp.spontaneous.general.common.api.exception.IllegalEntityStateException
   *
  ...
  /**
   * @see io.oasp.spontaneous.general.common.api.exception.NoActiveUserException
   *
   * @return the {@link NlsMessage}.
   */
  ...
  /**
   * @see io.oasp.spontaneous.offermanagement.common.api.exception.OfferEmptyException
   *
   * @return the {@link NlsMessage}.
   */
  ...
  /**
   * @see io.oasp.spontaneous.salesmanagement.common.api.exception.ChangeTableIllegalStateCombinationException
   *
