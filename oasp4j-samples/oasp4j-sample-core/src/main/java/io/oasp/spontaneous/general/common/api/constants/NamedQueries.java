package io.oasp.spontaneous.general.common.api.constants;
...
public abstract class NamedQueries {
  ...
  /** @see io.oasp.spontaneous.tablemanagement.dataaccess.impl.dao.TableDaoImpl#getFreeTables() */
  public static final String GET_FREE_TABLES = "get.free.tables";

  /** @see io.oasp.spontaneous.staffmanagement.dataaccess.impl.dao.StaffMemberDaoImpl#findByLogin(String) */
  public static final String GET_STAFF_MEMBER_BY_LOGIN = "get.staff.member.by.login";

  /** @see io.oasp.spontaneous.salesmanagement.dataaccess.impl.dao.OrderPositionDaoImpl */
  ...
  /** @see io.oasp.spontaneous.salesmanagement.dataaccess.impl.dao.OrderDaoImpl */
