package io.oasp.spontaneous.general.common.api.datatype;

import java.security.Principal;

// BEGIN ARCHETYPE SKIP
/**
 * Defines the available roles of a {@link io.oasp.spontaneous.staffmanagement.common.api.StaffMember}.
 *
 * @see io.oasp.spontaneous.staffmanagement.common.api.StaffMember#getRole()
 *
 * @author hohwille
 * @author loverbec
 */
