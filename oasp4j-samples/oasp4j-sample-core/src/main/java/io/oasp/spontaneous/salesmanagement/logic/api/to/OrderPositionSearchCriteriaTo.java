 ...
 * used to find {@link io.oasp.spontaneous.salesmanagement.common.api.OrderPosition}s.
 *
 * @author hohwille
 */
public class OrderPositionSearchCriteriaTo extends SearchCriteriaTo {
  ...
  /**
   * @return the {@link io.oasp.spontaneous.salesmanagement.common.api.OrderPosition#getOrderId() order ID} of
   *         the {@link io.oasp.spontaneous.salesmanagement.common.api.OrderPosition}s to find or
  ...
  /**
   * @return the {@link io.oasp.spontaneous.salesmanagement.common.api.OrderPosition#getCookId() cook ID} of
   *         the {@link io.oasp.spontaneous.salesmanagement.common.api.OrderPosition}s to find or
   *         {@code null} if no such criteria shall be added.
   */
  ...
  /**
   * @return {@code true} if only {@link io.oasp.spontaneous.salesmanagement.common.api.OrderPosition}s
