...
public interface UcFindOrder {
  ...
  /**
   * This method returns a the {@link io.oasp.spontaneous.salesmanagement.common.api.datatype.OrderState#OPEN
   * open} {@link OrderEto order} for the specified table.
   *
   * @param tableId the {@link io.oasp.spontaneous.tablemanagement.common.api.Table#getId() table ID} the
   ...
   *         {@link io.oasp.spontaneous.salesmanagement.common.api.datatype.OrderState#OPEN open}
