...
/**
 * Represents the state of an {@link io.oasp.spontaneous.salesmanagement.common.api.Order}.
 *
 * @author rjoeris
 */
public enum OrderState {
  ...
  /**
   * @return {@code true} if the {@link io.oasp.spontaneous.salesmanagement.dataaccess.api.OrderEntity}
   *         is ordered
   */
