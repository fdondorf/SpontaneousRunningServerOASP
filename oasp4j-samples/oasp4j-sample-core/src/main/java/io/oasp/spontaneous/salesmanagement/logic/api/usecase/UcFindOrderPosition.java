...
/**
 * Interface of {@link io.oasp.spontaneous.general.logic.base.AbstractUc use case} to get or find specific
...
public interface UcFindOrderPosition {
  ...
  /**
   * @param orderId is the {@link io.oasp.spontaneous.salesmanagement.common.api.Order#getId() ID} of the
   *        {@link io.oasp.spontaneous.salesmanagement.common.api.Order} for which the
