...
import io.oasp.spontaneous.salesmanagement.logic.api.to.OrderPositionSearchCriteriaTo;
...
public interface OrderPositionDao extends ApplicationDao<OrderPositionEntity> {
  ...
  /**
   * @param orderId is the {@link io.oasp.spontaneous.salesmanagement.logic.api.to.OrderEto#getId() ID} for
  ...
  /**
   * @param orderId is the {@link io.oasp.spontaneous.salesmanagement.logic.api.to.OrderEto#getId() table ID}
   ...
   *         {@link io.oasp.spontaneous.salesmanagement.common.api.datatype.OrderPositionState#isClosed()
   *         closed} and are {@link io.oasp.spontaneous.salesmanagement.logic.api.to.OrderEto#getId() table
   *         ID} with the given {@link io.oasp.spontaneous.salesmanagement.logic.api.to.OrderEto}. Will be the
