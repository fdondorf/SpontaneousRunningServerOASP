package io.oasp.spontaneous.tablemanagement.common.api;
...
public interface Table extends ApplicationEntity {
  ...
  /**
   * @return the {@link io.oasp.spontaneous.staffmanagement.common.api.StaffMember#getId() ID} of the waiter
