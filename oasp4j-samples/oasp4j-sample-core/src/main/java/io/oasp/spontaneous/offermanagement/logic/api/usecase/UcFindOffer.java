...
public interface UcFindOffer {
   ...
   *
   * @param id is the {@link io.oasp.spontaneous.offermanagement.common.api.Offer#getId() offer ID}.
   * @return the requested {@link io.oasp.spontaneous.offermanagement.common.api.Offer} or {@code null} if no
   *         such {@link io.oasp.spontaneous.offermanagement.common.api.Offer} exists.
   */
